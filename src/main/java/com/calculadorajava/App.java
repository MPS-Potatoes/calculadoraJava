...
public class App {
    ...
    // TODO: Crear funcionalidades de multiplicación y división -
    // https://trello.com/c/SCle7pYL/1-crear-funcionalidades-de-multiplicaci%C3%B3n-y-divisi%C3%B3n
    ...
    public static void main(String args[]) {
        ...
        do {
            ...
            switch (op) {
                ...
                case 4: {
                    if (b == 0)
                        System.out.println("Esta operacion no puede realizarse.\n");
                    else
